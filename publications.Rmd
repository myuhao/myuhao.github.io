...
[[PubMed]](https://pubmed.ncbi.nlm.nih.gov/34813500/)
    ...
    ```
      <div class="paper_abstract">
      We systematically compared the transcriptome between AD, PSP, and control subjects in two brain regions with different neuropathology. We identified conserved gene expression perturbations among the two distinct proteinopathies that are enriched in common biological pathways.
      </div>
...
[[PubMed]](https://pubmed.ncbi.nlm.nih.gov/28792758/)
    ...
    ```
      <div class="paper_abstract">
      We report an automated screening workflow that utilizes MALDI-ToF MS to speed up product detection in bacteria colonies. The rapid screening of the bacteria can enable the discovery of novel antibiotics.
      </div>
...
1. <div class="paper_title">
<span class="under">Yuhao Min</span>, Xue Wang, Özkan İş, Tulsi Patel, Joseph S Reddy, Thuy Nguyen, Jessica L. Chalk, Frederick Q. Tutor-New, Julia E. Crook, Minerva M. Carrasquillo, Dennis W. Dickson, Ke Zhang, Mariet Allen, Nilüfer Ertekin-Taner;
...
Alzheimer’s Association International Conference, Alzheimer’s Association, Online, **2022**. (Poster)
</div>
...
Association for Clinical and Translational Science Conference, Association for Clinical and Translational Science, **2022** (Poster)
</div>
